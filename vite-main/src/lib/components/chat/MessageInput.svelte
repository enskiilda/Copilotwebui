                                                                ...
                                                                <div class="self-end flex items-center flex-1 max-w-[80%]">
                                                                        ...
                                                                        >
                                                                                <div
                                                                                        ...
                                                                                        class="flex h-8 w-8 items-center justify-center rounded-full text-gray-800 dark:text-white transition-colors hover:bg-gray-100 dark:hover:bg-[#515151] focus-visible:outline-none"
                                                                                >
